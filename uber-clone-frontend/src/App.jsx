                    ...
                    <div className="space-x-6 flex items-center">
                        ...
                        {user && (
                            <>
                                ...
                                <button
                                    onClick={logout}
                                    className="flex items-center space-x-2 bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white px-4 py-2 rounded-lg transition-all duration-300 hover:shadow-lg hover:scale-[1.02]"
                                >
                                    <svg
            ...
            <section className="relative pt-32 bg-gradient-to-br from-indigo-900 via-blue-900 to-cyan-900 text-white py-28 overflow-hidden">
                ...
                <div className="container mx-auto px-4 text-center relative">
                    ...
                    <p className="text-xl md:text-2xl mb-10 max-w-3xl mx-auto animate-fade-in-up animation-delay-100">
                        Revolutionize your commute with ride matching, real-time tracking, and eco-friendly transportation solutions.
                    </p>
            ...
            <footer className="bg-indigo-900 text-white py-12">
                <div className="container mx-auto px-4">
                    ...
                    <div className="border-t border-white/10 mt-12 pt-8 text-center text-gray-400">
                        <p>&copy; 2025 VeloRide. All rights reserved.</p>
                    </div>
                </div>
            </footer>
        </div>
