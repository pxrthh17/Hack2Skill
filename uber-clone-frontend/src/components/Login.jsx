            ...
            <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-xl shadow-2xl transition-all duration-300 hover:shadow-3xl">
                ...
                <div className="mt-6">
                    ...
                    <div className="mt-6 grid grid-cols-2 gap-3">
                        <a href="#" className="w-full flex items-center justify-center px-4 py-2 border border-gray-300 rounded-lg shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors duration-200">
